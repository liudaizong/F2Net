...
class DAVIS(object):
    SUBSET_OPTIONS = ['train', 'val_seqs', 'test-dev', 'test-challenge']
    ...
    def __init__(self, root, task='unsupervised', subset='val', sequences='all', resolution='480p', codalab=False):
        ...
        annotations_folder = 'Annotations' if task == 'semi-supervised' else 'Annotations_new' #Annotations_new
        self.mask_path = os.path.join(self.root, annotations_folder, resolution)
        year = '2016' if task == 'unsupervised' else '2017'
